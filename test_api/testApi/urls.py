...
router.register(r'all_delivery_points', views.DeliveryPointViewsSet, basename='asd')

router.register(r'get_user_bank_cards/(?P<user_id>\d+)', views.BankCardsViewsSet)
router.register(r'add_bank_card/(?P<user_id>\d+)', views.AddBankCardViewSet, basename='bankcardss')

router.register(r'^products/(?P<start_limit>\d+)/(?P<count>\d+)', views.ProductViewSet, basename='productss')
...
router.register(r'get_current_card/(?P<user_id>\d+)', views.CurrentBankCardViewsSet, basename='bankcardsfs')
